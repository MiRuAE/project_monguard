...
void loop() { 
  ...
  if (state==2) { 
    ...
    Serial.println("If calibration was successful write down your offsets so you can set them in your projects using something similar to mpu.setXAccelOffset(youroffset)");
    while (1);
  } 
}
...
void calibration(){ 
  ...
  while (1){ 
    ...
    else gy_offset=gy_offset-mean_gz/(giro_deadzone+1);
