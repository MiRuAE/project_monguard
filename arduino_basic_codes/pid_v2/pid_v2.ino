...
PID pid0(&input0, &output0, &setpoint0, pid_p, pid_i, pid_d, DIRECT);

// PID variables for motor 1
double setpoint1, input1, output1;
PID pid1(&input1, &output1, &setpoint1, pid_p, pid_i, pid_d, DIRECT);
...
void loop() {
  ...
  float p_value = analogRead(potPin_p) / 10230.0 * 10; // Assuming PID P range 0-10
  float i_value = analogRead(potPin_i) / 10230.0 * 10; // Assuming PID I range 0-10
  float d_value = analogRead(potPin_d) / 102300.0 * 10; // Assuming PID D range 0-10
